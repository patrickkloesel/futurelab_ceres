...
iea_transport_taxation_1 <- rbind(iea_transport_taxation_d, iea_transport_taxation_p) %>% distinct(.keep_all = TRUE)

write_csv(iea_transport_taxation_1, "C:/Users/laura/OneDrive/Documenti/LAURA/MCC/futurelab_ceres/iea_transport_taxation.csv")
