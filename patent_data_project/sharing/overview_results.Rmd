...
**Most recent modeling choice**

 * Sample: removed Singapore, Taiwan **AND BRAZIL** after thorough analysis of zeros. We now have a total of 16 zeros across the whole sample, distributed in the following countries: FIN	3, IND	3, NOR	3, BEL	2, CHN	2, AUT	1, DNK	1, ISR	1. The technology with most zeros is wind with 12 zeros. 
 ...
 * Y transformations: IHS
 * Controls: gdp, pop
 * AR term = 1
 * IIS=ON
 * p-val = 0.01
 * **Sample**: N=22 (-SGP,TWN, BRA)
...
OECD policy data filtered for **Electricity, Cross-sectoral, International** modules. 
...
### Old breaks (-singapore and taiwan) {.tabset}
