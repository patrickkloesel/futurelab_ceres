---
title: "new results with brown patents control"
...
## libraries
suppressWarnings(suppressMessages(library(ragg)))
...
res <- readRDS("C:\\Users\\laura\\OneDrive\\Documenti\\LAURA\\MCC\\futurelab_ceres\\patent_data_project\\results\\22_03_brown.RDS") %>% 
 ...
 * Controls: gdp, pop, **brown patents**
...
```{r models comp, echo=FALSE, results = 'asis', fig.height=30, fig.width=50, include=FALSE, cache = TRUE}
...
#         for(sm in unique(.x$p_val)){
#              cat('#### ', sm, '{.tabset}   \n')
#                  .x %>% filter(p_val == sm) %>% plot_comp_new(., sign = "all")
#                cat('\n')
#                cat('\n')
#                cat('\n')
#       }
